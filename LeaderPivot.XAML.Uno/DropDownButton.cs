...
public partial class DropDownButton : ContentControl, INotifyPropertyChanged
{
    ...
    public static readonly DependencyProperty CommandProperty =
        DependencyProperty.Register("Command", typeof(ICommand), typeof(DropDownButton), new PropertyMetadata(null));
    ...
    public static readonly DependencyProperty SelectionChangedCommandProperty =
        DependencyProperty.Register("SelectionChangedCommand", typeof(ICommand), typeof(DropDownButton), new PropertyMetadata(null));
